...
<body class="font-sans text-gray-900 antialiased bg-gray-50 dark:bg-gray-900">
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-950 dark:via-gray-900 dark:to-indigo-950">
        <div class="mb-8 text-center">
            <a href="/">
                <x-application-logo class="w-24 h-24 mx-auto mb-4 drop-shadow-md" />
            </a>
            <h1 class="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight">SIAPS Admin</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">Sistem Informasi Administrasi Pelayanan Surat</p>
        </div>

        <div class="w-full sm:max-w-md px-8 py-8 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl shadow-2xl overflow-hidden sm:rounded-3xl border border-white/20 dark:border-gray-800/50">
            {{ $slot }}
        </div>
    </div>
