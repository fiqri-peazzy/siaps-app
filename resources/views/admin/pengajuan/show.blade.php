<x-app-layout>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-3">
            @if (session('error'))
                <div
                    class="p-4 mb-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-2xl text-red-800 dark:text-red-400 font-bold text-sm">
                    ⚠️ {{ session('error') }}
                </div>
            @endif
            @if (session('success'))
                <div
                    class="p-4 mb-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-2xl text-green-800 dark:text-green-400 font-bold text-sm">
                    ✅ {{ session('success') }}
                </div>
            @endif
        </div>
            ...
            <div
                ...
                <div class="space-y-4 text-xs font-bold">
                    ...
                    @elseif ($pengajuan->status === 'approved')
                        <div class="space-y-4">
                            <div
                                class="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl flex items-start gap-3">
                                ...
                                <div>
                                    <p
                                        class="text-xs font-bold text-green-800 dark:text-green-400 uppercase tracking-wider">
                                        Surat Disetujui</p>
                                    <p class="text-[10px] text-green-700 dark:text-green-500 mt-1">Surat telah
                                        disetujui dan ditandatangani Kepala Desa.</p>
                                </div>
                            </div>
