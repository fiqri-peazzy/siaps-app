                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400">Master Data</span>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400">Agama</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        ...
        <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
            <div class="flex items-center mb-4 sm:mb-0">
                <form class="sm:pr-3" action="{{ route('admin.master.agama.index') }}" method="GET">
                    <label for="agama-search" class="sr-only">Search</label>
                    <div class="relative w-48 mt-1 sm:w-64 xl:w-96">
                        ...
                        <input type="text" name="search" id="agama-search" value="{{ request('search') }}"
            ...
            <div class="flex items-center gap-3">
                <span class="text-sm text-gray-500 dark:text-gray-400">
                    Total: <span class="font-semibold text-gray-900 dark:text-white">{{ $agamas->count() }}</span> data
                </span>
                    ...
                    <div class="overflow-hidden shadow sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                @forelse($agamas as $index => $a)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        <td class="p-4 text-sm text-gray-500 dark:text-gray-400 w-12">
                                            {{ $index + 1 }}</td>
                                        <td
                                        ...
                                        <td class="p-4 space-x-2 whitespace-nowrap">
                                            <button type="button"
                                                ...
                                                class="inline-flex items-center gap-1 px-4 py-2 text-sm font-bold text-center text-white rounded-xl bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 transition-all shadow-md hover:shadow-blue-500/20 active:scale-95">
                                            ...
                                            <form action="{{ route('admin.master.agama.destroy', $a) }}"
                                                method="POST" class="inline">
                                                @csrf @method('DELETE')
                                                <button type="submit"
                                                    onclick="return confirm('Yakin ingin menghapus agama ini?')"
                                                    class="inline-flex items-center gap-1 px-4 py-2 text-sm font-bold text-center text-white bg-red-500 rounded-xl hover:bg-red-600 focus:ring-4 focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 transition-all shadow-md hover:shadow-red-500/20 active:scale-95">
                                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd"
                                    ...
                                    <tr>
                                        <td colspan="3" class="p-8 text-center">
                                            <div class="flex flex-col items-center justify-center gap-2">
                                                ...
                                                <p class="text-gray-500 dark:text-gray-400">Data agama belum ada.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
        ...
        <div class="relative w-full max-w-md max-h-full transition-transform duration-300 ease-out transform scale-95 opacity-0"
            ...
            <div
                ...
                <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white">Tambah Agama</h3>
                    <button type="button"
                ...
                <form action="{{ route('admin.master.agama.store') }}" method="POST">
                    ...
                    <div class="p-6">
                        ...
                        <div
                            ...
                            <button type="button" data-modal-hide="add-agama-modal"
        ...
        <div id="edit-agama-modal-{{ $a->id }}" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-md max-h-full transition-transform duration-300 ease-out transform scale-95 opacity-0"
                ...
                <div
                    class="relative bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl dark:bg-gray-800/90 border border-white/20 dark:border-gray-700/30">
                    <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white">Edit Agama</h3>
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-xl text-sm w-9 h-9 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-700 dark:hover:text-white transition-colors"
                    ...
                    <form action="{{ route('admin.master.agama.update', $a) }}" method="POST">
                        ...
                        <div
                            ...
                            <button type="button" data-modal-hide="edit-agama-modal-{{ $a->id }}"
                                class="py-3 px-6 text-sm font-bold text-gray-700 focus:outline-none bg-gray-100 rounded-xl border border-gray-200 hover:bg-gray-200 dark:focus:ring-gray-700 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-600 transition-all">Batal</button>
                        </div>
                    </form>
                </div>
