                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center"><svg class="rtl:rotate-180 w-3 h-3 text-gray-400 mx-1"
                                ...
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="m1 9 4-4-4-4" />
                            </svg><span class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400">Jabatan</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
            <div class="flex items-center mb-4 sm:mb-0">
                <form class="sm:pr-3" action="{{ route('admin.master.jabatan.index') }}" method="GET">
            ...
            <div class="flex items-center gap-3">
                <span class="text-sm text-gray-500 dark:text-gray-400">Total: <span
                        class="font-semibold text-gray-900 dark:text-white">{{ $jabatans->count() }}</span> data</span>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                @forelse($jabatans as $j)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        <td class="p-4 text-sm text-gray-500 dark:text-gray-400">{{ $j->urutan }}
                                        </td>
                                        ...
                                        <td class="p-4">
                                            @if ($j->is_penandatangan)
                                                <span
                                                    class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">Ya</span>
                                            @else
                                                <span
                                                    class="bg-gray-100 text-gray-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">Tidak</span>
                                            @endif
                                        </td>
        ...
        <div class="relative w-full max-w-md max-h-full transition-transform duration-300 ease-out transform scale-95 opacity-0"
            ...
            <div
                ...
                <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white">Tambah Jabatan</h3>
                    <button type="button"
                ...
                <form action="{{ route('admin.master.jabatan.store') }}" method="POST">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            <label
                                class="block mb-2 text-sm font-semibold text-gray-900 dark:text-gray-200">Singkatan</label>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block mb-2 text-sm font-semibold text-gray-900 dark:text-gray-200">Tanda
                                    Tangan?</label>
                    ...
                    <div
                        ...
                        <button type="button" data-modal-hide="add-jabatan-modal"
        ...
        <div id="edit-jabatan-modal-{{ $j->id }}" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-md max-h-full transition-transform duration-300 ease-out transform scale-95 opacity-0"
                ...
                <div
                    class="relative bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl dark:bg-gray-800/90 border border-white/20 dark:border-gray-700/30">
                    <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white">Edit Jabatan</h3>
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-xl text-sm w-9 h-9 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-700 dark:hover:text-white transition-colors"
                    ...
                    <form action="{{ route('admin.master.jabatan.update', $j) }}" method="POST">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label
                                        class="block mb-2 text-sm font-semibold text-gray-900 dark:text-gray-200">Tanda
                                        Tangan?</label>
                                    <select name="is_penandatangan"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-3 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-all outline-none">
                        ...
                        <div
                            ...
                            <button type="button" data-modal-hide="edit-jabatan-modal-{{ $j->id }}"
                                class="py-3 px-6 text-sm font-bold text-gray-700 focus:outline-none bg-gray-100 rounded-xl border border-gray-200 hover:bg-gray-200 dark:focus:ring-gray-700 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-600 transition-all">Batal</button>
                        </div>
                    </form>
                </div>
