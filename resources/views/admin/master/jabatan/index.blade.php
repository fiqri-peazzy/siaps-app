                ...
                <form action="{{ route('admin.master.jabatan.store') }}" method="POST">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanda
                                    Tangan?</label>
                    ...
                    <div
                        ...
                        <button type="button" data-modal-hide="add-jabatan-modal"
                            class="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Batal</button>
                    </div>
                </form>
            </div>
        </div>
