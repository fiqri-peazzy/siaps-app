<x-public-layout>
    ...
    <section class="relative py-32 lg:py-40 px-4 overflow-hidden flex items-center min-h-[50vh]">
        <div class="absolute inset-0">
            <img src="{{ asset('images/banners/layanan_surat.png') }}" class="w-full h-full object-cover object-center" alt="Banner Layanan Surat">
        ...
        <div class="relative max-w-7xl mx-auto w-full z-10">
            <div class="max-w-3xl">
                <span class="inline-block py-1.5 px-4 rounded-full bg-blue-600/80 backdrop-blur-md text-white text-xs font-black tracking-widest uppercase mb-6 border border-blue-400/30 shadow-lg">Layanan Publik</span>
                <h1 class="text-5xl md:text-7xl font-black text-white mb-6 leading-tight drop-shadow-xl">Layanan Administrasi Digital</h1>
                <p class="text-blue-100 text-lg md:text-xl font-medium drop-shadow-md leading-relaxed">Pilih jenis layanan surat yang Anda butuhkan.
